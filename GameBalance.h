...
namespace GameBalance {
	...
	namespace Items {
		...
		enum class PropId {
			...
			// Turret
			TURRET_TIME_TO_ACQUIRE_TARGET = 8001,
			TURRET_CAN_TARGET_VEHICLES = 8002,

			// Mines
			MINE_DEPLOY_TIME = 9000,
			MINE_COLLISION_CYLINDER_RADIUS = 9001,
			MINE_COLLISION_CYLINDER_HEIGHT = 9002,
			CLAYMORE_DETONATION_ANGLE = 9003,
			PRISM_MINE_TRIP_DISTANCE = 9004,
