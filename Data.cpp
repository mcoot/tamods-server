...
namespace Data
{
    ...
    std::map<std::string, int> map_id = {
        ...
        { R"rx(^arena[-_]?(ru|ins).*$)rx",              CONST_MAP_ID_ARENA_RUINS },
        { R"rx(^arena[-_]?(ely|ound).*$)rx",            CONST_MAP_ID_ARENA_ELYSIANBATTLEGROUND },
        ...
        { R"rx(^ctf[-_]?(ach|ron).*$)rx",               CONST_MAP_ID_CTF_ACHERON },
        { R"rx(^ctf[-_]?(blu|es).*$)rx",                CONST_MAP_ID_CTF_BLUES },
        { R"rx(^ctf[-_]?(des|lley).*$)rx",              CONST_MAP_ID_CTF_DESERTEDVALLEY },
        { R"rx(^ctf[-_]?(fra|ture).*$)rx",              CONST_MAP_ID_CTF_FRACTURE },
        { R"rx(^ctf[-_]?(inci|mus).*$)rx",              CONST_MAP_ID_CTF_INCIDAMUS },
        { R"rx(^ctf[-_]?(per|ulo).*$)rx",               CONST_MAP_ID_CTF_PERICULO },
        { R"rx(^ctf[-_]?(phle|hon).*$)rx",              CONST_MAP_ID_CTF_PHLEGATHON },
        { R"rx(^ctf[-_]?(st|yx).*$)rx",                 CONST_MAP_ID_CTF_STYX },
        { R"rx(^ctf[-_]?(oce|us).*$)rx",                CONST_MAP_ID_CTF_OCEANUS },
        { R"rx(^ctf[-_]?(trea|pass).*$)rx",             CONST_MAP_ID_CTF_TREACHEROUSPASS },
        { R"rx(^ctf[-_]?(mer|ian).*$)rx",               CONST_MAP_ID_CTF_MERIDIAN },
        { R"rx(^ctf[-_]?(as|ent).*$)rx",                CONST_MAP_ID_CTF_ASCENT },
    ...
    std::map<int, std::string> map_id_to_name = {
        ...
        { CONST_MAP_ID_CTF_ACHERON,                "[CTF] Acheron" },
        { CONST_MAP_ID_CTF_BLUES,                  "[CTF] Blues" },
        { CONST_MAP_ID_CTF_DESERTEDVALLEY,         "[CTF] Deserted Valley" },
        { CONST_MAP_ID_CTF_FRACTURE,               "[CTF] Fracture" },
        { CONST_MAP_ID_CTF_INCIDAMUS,              "[CTF] Incidamus" },
        { CONST_MAP_ID_CTF_PERICULO,               "[CTF] Periculo" },
        { CONST_MAP_ID_CTF_PHLEGATHON,             "[CTF] Phlegathon" },
        { CONST_MAP_ID_CTF_STYX,                   "[CTF] Styx" },
        { CONST_MAP_ID_CTF_OCEANUS,                "[CTF] Oceanus" },
        { CONST_MAP_ID_CTF_TREACHEROUSPASS,        "[CTF] Treacherous Pass" },
        { CONST_MAP_ID_CTF_MERIDIAN,               "[CTF] Meridian" },
        { CONST_MAP_ID_CTF_ASCENT,                 "[CTF] Ascent" },
    ...
    std::map<int, std::string> map_id_to_filename = {
        ...
        { CONST_MAP_ID_CTF_ACHERON,                "TrCTF-Acheron" },
        { CONST_MAP_ID_CTF_BLUES,                  "TrCTF-Blues" },
        { CONST_MAP_ID_CTF_DESERTEDVALLEY,         "TrCTF-Deserted Valley" },
        { CONST_MAP_ID_CTF_FRACTURE,               "TrCTF-Fracture" },
        { CONST_MAP_ID_CTF_INCIDAMUS,              "TrCTF-Incidamus" },
        { CONST_MAP_ID_CTF_PERICULO,               "TrCTF-Periculo" },
        { CONST_MAP_ID_CTF_PHLEGATHON,             "TrCTF-Phlegathon" },
        { CONST_MAP_ID_CTF_STYX,                   "TrCTF-Styx" },
        { CONST_MAP_ID_CTF_OCEANUS,                "TrCTF-Oceanus" },
        { CONST_MAP_ID_CTF_TREACHEROUSPASS,        "TrCTF-Treacherous Pass" },
        { CONST_MAP_ID_CTF_MERIDIAN,               "TrCTF-Meridian" },
        { CONST_MAP_ID_CTF_ASCENT,                 "TrCTF-Ascent" },
